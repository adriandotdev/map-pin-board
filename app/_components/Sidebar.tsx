...
export const Sidebar = () => {
	...
	return (
		<div
			className={`hidden xl:fixed bottom-0 z-999 left-0 w-full bg-white rounded-t-2xl shadow-lg py-4 h-full xl:h-auto xl:flex xl:flex-col xl:max-w-87.5 xl:top-20 xl:bottom-10 xl:rounded-b-2xl xl:left-10 xl:shadow-2xl ${locations.length > 0 ? "max-h-75" : "max-h-62.5"} max-h-none transition-all`}
		>
			...
			<div className="overflow-y-auto max-h-60 xl:flex-1 xl:max-h-none xl:min-h-0 overflow-x-hidden">
				<AnimatePresence>
